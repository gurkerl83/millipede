...
/**
 * @version $Id: DownloadTransfer.java 5830 2010-03-03 12:02:26Z dkocher $
 */
public class DownloadTransfer extends Transfer implements DownloadTransferService {
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.DownloadTransferService#getAsDictionary()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.DownloadTransferService#childs(ch.cyberduck.core.Path)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.DownloadTransferService#filter(ch.cyberduck.core.TransferAction)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.DownloadTransferService#action(boolean, boolean)
	 */
    @Override
...
//            Growl.instance().notify("Download complete", getName());
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.DownloadTransferService#isResumable()
	 */
    @Override
