...
//import com.aelitis.azureus.core.AzureusCore_;
import java.io.File;
...
//import org.milipede.merapi.handlers.DLControlRequestHandler;
//import org.milipede.merapi.messages.DLControlMessage;
//import org.milipede.traydock.merapi.handlers.TrayDockMessageHandler;
 ...
 * 
 */
public class GlobalManagerImpl_ 
	extends DownloadManagerAdapter
	implements 	GlobalManager, BundleActivator//, AEDiagnosticsEvidenceGenerator
{
...
//   public AzureusCore_ core;
    @Override
    public void start(BundleContext context) throws Exception {

        ServiceRegistration reg;
        ServiceReference ref;
//        ref = context.getServiceReference(AzureusCore_.class.getName());
//        core = (AzureusCore_)context.getService(ref);
//        GlobalManager gm = new GlobalManagerImpl();
        context.registerService(GlobalManager.class.getName(), new GlobalManagerImpl(), null);
        
//        Bridge.getInstance().registerMessageHandler(TrayDockMessage.ASK_IT, trayDockMessageHandler);
//        Bridge.getInstance().registerMessageHandler(DLControlMessage.DL_CONTROL, new DLControlRequestHandler(this));
...
//        Bridge.getInstance().unRegisterMessageHandler(TrayDockMessage.ASK_IT, trayDockMessageHandler);
        ServiceReference ref;
...
//  private TrayDockMessageHandler trayDockMessageHandler;
  public 
  GlobalManagerImpl_() {
      
//      trayDockMessageHandler = new TrayDockMessageHandler(this);
...
//				  + " : " + manager.getTorrentFileName());
      ...
      if( state != DownloadManager.STATE_STOPPED &&
        ...
        System.out.println("stopAllDownloads Processed");
  }
  ...
  public void startAllDownloads() {    
    ...
    System.out.println("startAllDownloads Processed");
  }
...
//	    	  Debug.printStackTrace( e );
  ...
  pauseDownloads() 
  {
      System.out.println("process pauseDownloads");
...
//        	Debug.printStackTrace( e );
  ...
  public void resumeDownloads() {
    System.out.println("process resumeDownloads");
