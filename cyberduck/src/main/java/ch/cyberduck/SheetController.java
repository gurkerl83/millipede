...
//    protected void callback(final int returncode, ID context) {
     protected void callback(final int returncode, String context) {
...
//                null); //context
     ...
     */
    public void sheetDidClose_returnCode_contextInfo(final int returncode) { //, ID contextInfo) { //final NSWindow sheet, final int returncode, ID contextInfo) {
//        sheet.orderOut(null);
        String contextInfo = "";
