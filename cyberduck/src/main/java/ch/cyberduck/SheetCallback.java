...
public interface SheetCallback {
     ...
     */
    public final int DEFAULT_OPTION = 0; //NSAlert.NSAlertDefaultReturn;
    /**
     * Usually cancel option
     */
    public final int OTHER_OPTION = 1; //NSAlert.NSAlertOtherReturn;
    /**
     * Cancel proposed operation
     */
    public final int ALTERNATE_OPTION = 2; //NSAlert.NSAlertAlternateReturn;
