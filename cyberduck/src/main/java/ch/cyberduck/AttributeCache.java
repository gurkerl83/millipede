...
//    private Map<K, Map<String, NSObject>> impl;
	 ...
	 * @uml.associationEnd  qualifier="key:java.lang.String java.util.Map"
	 */
    private Map<K, Map<String, Object>> impl;
    ...
    public Object put(K key, String attribute, Object value) {
    ...
    public Object get(K key, String attribute) {
        if(!impl.containsKey(key)) {
            log.warn("No cached attributes for " + key);
            return null;
        }
        final Map<String, Object> attributes = impl.get(key);
