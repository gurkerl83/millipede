...
/**
 * @version  $Id: Host.java 5648 2010-01-01 22:32:01Z dkocher $
 */
...
//    private FTPConnectMode connectMode;
	 ...
	 * @uml.property  name="maxConnections"
	 */
    private Integer maxConnections;
    /**
	 * The custom download folder
	 * @uml.property  name="downloadFolder"
	 */
...
//                }
    ...
    /**
	 * @return  The character encoding to be used when connecting  to this server or null if the default encoding should be used
	 * @uml.property  name="encoding"
	 */
...
//    }
    ...
    /**
	 * Set a timezone for the remote server different from the local default timezone May be useful to display modification dates of remote files correctly using the local timezone
	 * @param  timezone
	 * @uml.property  name="timezone"
	 */
