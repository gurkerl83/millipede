 ...
 * @version  $Id: Permission.java 5625 2009-12-19 21:39:15Z dkocher $
 */
public class Permission implements Serializable {
    ...
    /**
	 * @uml.property  name="owner" multiplicity="(0 -1)" dimension="1"
	 */
    private boolean[] owner = new boolean[3];
    /**
	 * @uml.property  name="group" multiplicity="(0 -1)" dimension="1"
	 */
    private boolean[] group = new boolean[3];
    /**
	 * @uml.property  name="other" multiplicity="(0 -1)" dimension="1"
	 */
