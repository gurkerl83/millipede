...
import ch.cyberduck.LoginController;
...
//                host.getHostname()));
    ...
    /**
	 * @uml.property  name="connectionListeners"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="ch.cyberduck.core.ConnectionListener"
	 */
...
//                this.getHost().getHostname()));
    ...
    /**
	 * @uml.property  name="transcriptListeners"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="ch.cyberduck.core.TranscriptListener"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="ch.cyberduck.core.ProgressListener"
	 */
    ...
    /**
	 * @uml.property  name="errorListeners"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="ch.cyberduck.core.ErrorListener"
	 */
