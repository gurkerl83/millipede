...
//
//    @Override
//    public void download(BandwidthThrottleService throttle, StreamListener listener, boolean check) {
...
//     */
//    @Override
//    protected void upload(BandwidthThrottleService throttle, StreamListener listener, Permission p, boolean check) {
//        try {
//            if(check) {
//                this.getSession().check();
//            }
