 ...
 * bytes.
 *
 * @version $Id: Status.java 5625 2009-12-19 21:39:15Z dkocher $
 */
public class Status {
    ...
    /**
	 * A state variable to mark this path if the path is explicitly selected for inclusion in the transfer prompt
