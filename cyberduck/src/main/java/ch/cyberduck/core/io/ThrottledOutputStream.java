 ...
 *
 * @version $Id: ThrottledOutputStream.java 2939 2007-04-20 12:52:33Z dkocher $
 */
public class ThrottledOutputStream extends OutputStream {
    ...
    /**
	 * Limits throughput.
	 * @uml.property  name="_throttle"
	 * @uml.associationEnd  multiplicity="(1 1)"
	 */
    private BandwidthThrottleService _throttle;
    ...
    public ThrottledOutputStream(OutputStream delegate,
                                 BandwidthThrottleService throttle) {
