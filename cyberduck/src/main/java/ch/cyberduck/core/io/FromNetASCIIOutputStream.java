...
public final class FromNetASCIIOutputStream extends FilterOutputStream {
	/**
	 * @uml.property  name="__lastWasCR"
	 */
	private boolean __lastWasCR;

	/**
	 * @uml.property  name="_noConversionRequired"
	 */
	private boolean _noConversionRequired;
	/**
	 * @uml.property  name="_lineSeparator"
	 */
	private String _lineSeparator;
	/**
	 * @uml.property  name="_lineSeparatorBytes" multiplicity="(0 -1)" dimension="1"
	 */
