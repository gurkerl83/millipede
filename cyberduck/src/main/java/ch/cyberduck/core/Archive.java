 ...
 * @version   $Id: Archive.java 5746 2010-01-15 16:23:04Z dkocher $
 */
public abstract class Archive {
    private static Logger log = Logger.getLogger(Archive.class);

    /**
	 * @uml.property  name="tAR"
	 * @uml.associationEnd  
	 */
