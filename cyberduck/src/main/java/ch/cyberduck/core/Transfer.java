...
public abstract class Transfer implements Serializable {
	 ...
	 * @uml.property  name="transferred"
	 */
    protected double transferred = 0;

    /**
	 * The transfer has been canceled and should not continue any forther processing
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="ch.cyberduck.core.TransferListener"
	 */
