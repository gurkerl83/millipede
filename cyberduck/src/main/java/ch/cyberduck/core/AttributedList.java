...
public class AttributedList<E extends AbstractPath> extends CopyOnWriteArrayList<E> {
    ...
    /**
	 * @uml.property  name="references"
	 * @uml.associationEnd  qualifier="getReference:ch.cyberduck.core.PathReference ch.cyberduck.core.AbstractPath"
	 */
