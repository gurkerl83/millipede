...
public abstract class Path extends AbstractPath implements Serializable {
	 ...
	 * @uml.property  name="tEXT_FILETYPE_PATTERN"
	 */
    private Pattern TEXT_FILETYPE_PATTERN = null;

    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getTextFiletypePattern()
	 */
    ...
    /**
	 * A compiled representation of a regular expression.
	 * @uml.property  name="bINARY_FILETYPE_PATTERN"
	 */
    private Pattern BINARY_FILETYPE_PATTERN;

    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getBinaryFiletypePattern()
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#init(T)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getAsDictionary()
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#setPath(java.lang.String, ch.cyberduck.core.Local)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#setPath(java.lang.String)
	 */
    /**
	 * @param name
	 * @uml.property  name="path"
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#setParent(ch.cyberduck.core.Path)
	 */
    /**
	 * @param parent
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getParent()
	 */
    /**
	 * @return
	 * @uml.property  name="parent"
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getParent(boolean)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getStatus()
	 */
    /**
	 * @return
	 * @uml.property  name="status"
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getHost()
	 */
    public Host getHost() {
        try {
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#cache()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#writeOwner(java.lang.String, boolean)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#writeGroup(java.lang.String, boolean)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#readChecksum()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#readSize()
	 */
    public abstract void readSize();

    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#readTimestamp()
	 */
    public abstract void readTimestamp();

    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#readPermission()
	 */
    public abstract void readPermission();

    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getName()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getAbsolute()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getReference()
	 */
    /**
	 * @param  < T  >
	 * @return
...
//            };
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#setLocal(ch.cyberduck.core.Local)
	 */
    /**
	 * @param file
	 * @uml.property  name="local"
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getLocal()
	 */
    /**
	 * @return
	 * @uml.property  name="local"
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#kind()
	 */
    public String kind() {
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#getSession()
	 */
    /**
	 * @uml.property  name="session"
	 * @uml.associationEnd  readOnly="true" inverse="workdir:ch.cyberduck.core.Session"
	 */
    public abstract Session getSession() throws ConnectionCanceledException;

    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#download()
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#download(boolean)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#download(ch.cyberduck.core.StreamListener)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#upload()
	 */
    public void upload() {
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#upload(ch.cyberduck.core.StreamListener)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#copy(ch.cyberduck.core.AbstractPath)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#exists()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#hashCode()
	 */
    @Override
    public int hashCode() {
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#equals(java.lang.Object)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#toString()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#encode(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#toURL()
	 */
    @Override
    public String toURL() {
    ...
    /* (non-Javadoc)
	 * @see ch.cyberduck.core.PathService#toHttpURL()
	 */
