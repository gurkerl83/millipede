...
public class MainController extends BundleController implements EventHandler { // implements NSApplication.Delegate {
...
//                        MainController.newDocument().mount(host);
//                    }
                    System.out.println("Session clearing");
//                    sessions.clear();
                }
            });
        }
...
//            LocalFactory.createLocal(Preferences.instance().getProperty("application.support.path"), "Sessions"));
	 ...
	 * @uml.property  name="donationPrompt"
	 */
...
//    }
    ...
    public static BrowserController newDocument() {
        return MainController.newDocument(true);
    }
    /**
	 * @uml.property  name="browsers"
	 */
...
//        "workspaceWillLogout"
//        "workspaceWillSleep"
//    	if (event.getTopic().equals(CyberduckConstants.URL_MESSAGE+"/"+CyberduckConstants.ADD)) {
    	
    	/*important but with line above
