...
//  }
  ...
  public TorrentDownloader(TorrentManager torrentManager, DownloadManager downloadManager) {
//	    this.view = view;
	    this.torrentManager = torrentManager;
	    this.downloadManager = downloadManager;
	  }
